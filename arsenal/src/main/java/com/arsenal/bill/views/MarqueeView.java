...
public class MarqueeView extends ViewFlipper {
    ...
    private float textLineHeight = -1;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textMaxLine = typedArray.getInteger(R.styleable.MarqueeViewStyle_mvTextMaxLine, animDuration);
        singleLine = typedArray.getBoolean(R.styleable.MarqueeViewStyle_mvSingleLine, false);
        if (typedArray.hasValue(R.styleable.MarqueeViewStyle_mvTextLineHeight)) {
            textLineHeight = typedArray.getDimension(R.styleable.MarqueeViewStyle_mvTextLineHeight, textSize);
        }
    ...
    private TextView createTextView(CharSequence text) {
        ...
        if (textView == null) {
            ...
            textView.setLineSpacing(textLineHeight, 1.0f);
