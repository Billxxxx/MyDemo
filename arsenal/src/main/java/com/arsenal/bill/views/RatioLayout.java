...
public class RatioLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        mIsWidthFitDrawableSizeRatio = a.getBoolean(R.styleable.RatioLayout_is_width_fix_drawable_size_ratio,
                mIsWidthFitDrawableSizeRatio);
        mIsHeightFitDrawableSizeRatio = a.getBoolean(R.styleable.RatioLayout_is_height_fix_drawable_size_ratio,
                mIsHeightFitDrawableSizeRatio);
        mHeightRatio = a.getFloat(
                R.styleable.RatioLayout_height_to_width_ratio, mHeightRatio);
        mWidthRatio = a.getFloat(
                R.styleable.RatioLayout_width_to_height_ratio, mWidthRatio);
        a.recycle();
    }
