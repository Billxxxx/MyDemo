...
public class CircularCoverView extends View {
    ...
    public CircularCoverView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int radius = typedArray.getDimensionPixelSize(R.styleable.CircularCoverView_ccv_radius, -1);
        if (radius > 0)
            leftTopRadians = leftBottomRadians = rightTopRadians = rightBottomRadians = radius;
